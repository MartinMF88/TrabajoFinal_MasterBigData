...
output_path = "C:\\Users\\Matias\\Desktop\\TrabajoFinal_MasterBigData\\04_RecommendationSystem\\NMF\\NMF_Balanced\\grid_results_nmf_balanced.csv"
results_df.to_csv(output_path, index=False)
print(f"\n✅ Resultados guardados en: {output_path}")

# Save Best Model Hyperparameters
best_result = results_df.sort_values(by="F1-score", ascending=False).iloc[0]
best_result_path = "C:\\Users\\Matias\\Desktop\\TrabajoFinal_MasterBigData\\04_RecommendationSystem\\NMF\\NMF_Balanced\\best_nmf_hyperparameters.csv"
